...
public class AccessoryTest2 {
    //vendor ID for Samsung Phone
    private final static short VENDOR_ID = (short) 0x2207;
...
//                        "SerialNumber");
                ...
                setupAccessory("Google, Inc.", "AccessoryChat", "Description", "1.0", "http://www.mycompany.com",
                        "SerialNumber");
